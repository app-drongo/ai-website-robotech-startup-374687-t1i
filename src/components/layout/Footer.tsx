...
const DEFAULT_FOOTER = {
  logoText: 'RoboTech',
  companyDescription:
    'Pioneering the future of robotics with cutting-edge AI technology and autonomous systems. Join the revolution in intelligent automation and robotic innovation.',
  contactEmail: 'hello@robotech.ai',
  contactPhone: '+1 (555) ROBOT-1',
  contactAddress: '2024 Innovation Drive, Tech Valley',
  newsletterTitle: 'Stay Connected',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer:
    'Get the latest robotics updates and innovations. No spam, unsubscribe anytime.',
  section1Title: 'Products',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 RoboTech. All rights reserved.',
  madeWithText: 'by RoboTech AI',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/robotech',
  social2Href: 'https://facebook.com/robotech',
  social3Href: 'https://instagram.com/robotech',
  social4Href: 'https://linkedin.com/company/robotech',
  social5Href: 'https://github.com/robotech',
  // Product Links
  linkFeatures: 'Autonomous Systems',
  linkFeaturesHref: '/autonomous',
  linkPricing: 'Pricing',
  linkPricingHref: '/pricing',
  linkTemplates: 'Robot Models',
  linkTemplatesHref: '/models',
  linkIntegrations: 'AI Integration',
  linkIntegrationsHref: '/ai-integration',
  ...
  // Resources Links
  linkHelp: 'Support Center',
  linkHelpHref: '/support',
  linkCommunity: 'Developer Community',
  ...
  linkCompliance: 'AI Ethics',
  linkComplianceHref: '/ethics',
  // Bottom Links
  linkSitemap: 'Sitemap',
